...
2. **Lambda 関数にコードを追加**
   - [`OgiriGetResults`](./lambda/OgiriGetResults.py)
...
### 6. 呼び出し用の bat ファイル
[`call_results_api.bat`](./bat/call_results_api.bat)ファイルを作成します。
