...
5. 「**オブジェクトをアップロード**」をクリックし、「`training-code/`」フォルダに`model.py`をアップロードします。
6. 「**オブジェクトをアップロード**」をクリックし、「`training-code/`」フォルダに`training_script.py`をアップロードします。
...
#### 9.2 推論スクリプトを S3 にアップロード

1. `ogiri-training-data-bucket/training-code/`で「**オブジェクトをアップロード**」をクリックし、`inference.py`をアップロードします。
